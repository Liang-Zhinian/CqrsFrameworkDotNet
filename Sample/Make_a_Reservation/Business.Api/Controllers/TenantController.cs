...
using Business.Api.Requests.Tenants;
...
namespace Business.Api.Controllers
{
    ...
    public class TenantController: Controller
    {
        ...
        {
            //return Json(Newtonsoft.Json.JsonConvert.SerializeObject("Success"));
            return Json(Newtonsoft.Json.JsonConvert.SerializeObject(_readmodel.GetAllTenants()));
        }
