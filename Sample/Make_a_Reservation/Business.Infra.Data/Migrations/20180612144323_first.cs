        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<string>(type: "char(32)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationId = table.Column<string>(type: "char(32)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForeignZip = table.Column<string>(type: "varchar(255)", nullable: true),
                    PostalCode = table.Column<string>(type: "varchar(255)", nullable: true),
                    StaffId = table.Column<string>(type: "char(32)", nullable: false),
                    State = table.Column<string>(type: "varchar(255)", nullable: false),
                    Street = table.Column<string>(type: "varchar(255)", nullable: false),
                    Street2 = table.Column<string>(type: "varchar(255)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LayoutId = table.Column<string>(type: "char(32)", nullable: false),
                    Name = table.Column<string>(type: "varchar(255)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleId = table.Column<string>(type: "char(32)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "char(32)", nullable: false),
                    ResourceId = table.Column<string>(type: "char(32)", nullable: false),
                    LocationId = table.Column<string>(type: "char(32)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceLocation", x => new { x.Id, x.ResourceId, x.LocationId });
                    table.UniqueConstraint("AK_ResourceLocation_Id", x => x.Id);
                    table.ForeignKey(
