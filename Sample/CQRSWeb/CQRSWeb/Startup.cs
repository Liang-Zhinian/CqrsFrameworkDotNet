...
using ISession = CqrsFramework.Domain.ISession;
using CqrsFramework.EventStore.SqlServerDB;
...
namespace CQRSWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IEventStore>(sp => new SqlServerEventStore(sp.GetService<IEventPublisher>(), "Server=localhost\\SQLEXPRESS;Database=CQRSWeb;Trusted_Connection=True;"));
