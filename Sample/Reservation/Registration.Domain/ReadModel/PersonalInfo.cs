...
namespace Registration.Domain.ReadModel
{
    ...
    public class PersonalInfo : IEquatable<PersonalInfo>
    {
        ...
        public static bool Equals(PersonalInfo obj1, PersonalInfo obj2)
        {
            ...
            return string.Equals(obj1.Email, obj2.Email, StringComparison.InvariantCultureIgnoreCase) &&
                ...
                obj1.LastName == obj2.LastName &&
                         obj1.PrimaryTelephone == obj2.PrimaryTelephone &&
                    obj1.SecondaryTelephone == obj2.SecondaryTelephone;
        }
        ...
        public override int GetHashCode()
        {
            ...
            if (this.PrimaryTelephone != null)
                hash ^= this.PrimaryTelephone.GetHashCode();
            if (this.SecondaryTelephone != null)
                hash ^= this.SecondaryTelephone.GetHashCode();
