...
{
    public class AvailabilityMap : BaseMap<Availability>, IEntityTypeConfiguration<Availability>
    {
        public void Configure(EntityTypeBuilder<Availability> builder)
        {
            base.Configure(builder, Constants.DbConstants.AvailabilityTable);
