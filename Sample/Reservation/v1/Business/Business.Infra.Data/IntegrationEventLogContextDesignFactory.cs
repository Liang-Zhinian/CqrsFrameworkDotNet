...
namespace Business.Infra.Data
{
    public class IntegrationEventLogContextDesignFactory : IDesignTimeDbContextFactory<IntegrationEventLogContext>
    {
        public IntegrationEventLogContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseMySql("Server=localhost;database=book2business;uid=root;pwd=P@ssword;charset=utf8;port=3306;SslMode=None", b => b.MigrationsAssembly("Business.Infra.Data"));
